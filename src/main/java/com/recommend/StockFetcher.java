...
public static Stock getStock(String symbol) {  
		...
		try { 
			...
			// Retrieve CSV Filehttp:
			URL yahoo = new URL("http://finance.yahoo.com/d/quotes.csv?s="+ symbol + "&f=l1vr2ejkghm3j3nc4c1pox");
			...
			perchange = sh.handleDouble(stockinfo[12]);
		...
		return new Stock(sym, price, volume, pe, eps, week52low, week52high, daylow, dayhigh, movingav50day, marketcap, name,currency, perchange,previousClose,open,exchange);
